...
export async function tenantRequest(action,udise,identifier){
 ...
 const response=await fetch(endpoint,{method:'POST',headers,body:JSON.stringify({action,udise,identifier}),signal:AbortSignal.timeout(20000)});
