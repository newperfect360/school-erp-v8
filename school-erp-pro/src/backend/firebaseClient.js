...
export function schoolFirebase(){
 ...
 client={app,auth,db,storage,schoolId:import.meta.env.VITE_SCHOOL_ID,projectId:config.projectId,emulator};
 if(!client.schoolId)throw Error('School tenant ID is required.');
 return client;
}
