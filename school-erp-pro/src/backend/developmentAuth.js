...
export function developmentLogin(username, password) {
  if (!developmentEnabled || !['admin','dilippawar2207@gmail.com'].includes(String(username).trim().toLowerCase()) || password !== 'admin1234') throw Error('Invalid development username or password.');
