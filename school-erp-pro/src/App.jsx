...
const groups = [
  ...
  { title: "शैक्षणिक व्यवस्थापन", items: [["Students", "विद्यार्थी", "users"], ["Teachers", "शिक्षक", "book"], ["Attendance", "उपस्थिती", "calendar"], ["Parents", "पालक", "users"], ["Homework", "गृहपाठ", "book"], ["Classwork", "वर्गपाठ", "file"], ["Results", "परीक्षा व निकाल", "chart", "निकाल"], ["Sports", "क्रीडा", "trophy"], ["Trips", "शैक्षणिक सहल", "pin"]] },
  { title: "शालेय कार्यालय", items: [["Fees", "शुल्क", "wallet"], ["Certificates", "प्रमाणपत्र", "file"], ["IDCard", "ओळखपत्र", "users", "ID Card"], ["Notices", "सूचना", "bell"], ["Reports", "अहवाल", "chart", "Reports"], ["Scholarships", "शिष्यवृत्ती", "trophy"], ["Meetings", "पालक सभा", "users"], ["Transport", "वाहतूक", "pin"], ["Communications", "संवाद नोंद", "bell"], ["Automation", "स्वयंचलित नियम", "settings"], ["Settings", "सेटिंग्ज", "settings", "Settings"]] },
];
const pages = { Students, Teachers, Attendance, Homework, Classwork, Certificates, Results, IDCard, Reports, Parents, Trips };
    ...
    {!login ? <div className="login-page">
      ...
      <main className="main-area"><header className="top-header"><button className="mobile-menu icon-button" onClick={() => setSidebarOpen(true)} aria-label="Open navigation"><Icon name="menu" /></button><div className="header-copy"><div className="header-school">{settings.schoolName}</div><div className="breadcrumb">शालेय व्यवस्थापन <Icon name="chevron" size={12} /><strong>{activeLabel}</strong></div></div><div className="header-actions"><span className="status-pill"><span /> Local workspace</span><div className="avatar">AD</div></div></header>
        <div className="page-content"><PageBoundary key={active}>
          {active === "Dashboard" ? <Dashboard settings={settings} onNavigate={navigate} /> : active === "Settings" ? <Settings onSaved={setSettings} /> : Page ? <Page /> : <OperationalModules key={active} module={active} />}
        </PageBoundary></div>
