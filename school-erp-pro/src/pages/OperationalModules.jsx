...
export default function OperationalModules({ module }) {
  ...
  const aliases=module==="Notices"?Object.fromEntries(definition.fields.map((label,index)=>[label,["title","audience","date","text","channel"][index]])):{};
  const [items, setItems, connection] = useSharedRecords(module==="Notices"?"notifications":null,definition.key,{aliases});
