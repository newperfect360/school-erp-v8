...
if (metadata.applicationId !== 'com.gbsschool.app' || !/^1\.0\.0(?:-perfectedu-demo)?$/.test(artifact.versionName) || artifact.versionCode !== 1) {
...
const file = `Perfect-Education-v${artifact.versionName}.apk`;
...
const release = {
  ...
  file, buildType: 'debug - development server required', minSdk: 24, targetSdk: 36,
